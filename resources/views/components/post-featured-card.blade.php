...
<article
    class="transition-colors duration-300 hover:bg-gray-900 border border-black border-opacity-0 hover:border-opacity-5 rounded-xl">
    @if($post->slug == "doume")
        <div class="bg-yellow-900 rounded-xl font-semibold text-white uppercase py-3 px-5 text-center">EN VEDETTE</div>
    @endif
    <div class="py-6 px-5 lg:flex">
        ...
        <div class="flex-1 flex flex-col justify-between">
            ...
            <div class="text-sm mt-2" style="color: white">
                <p>
                    {{ $post->excerpt }}
                </p>
                <br>
                <h6 style="color: white"><p> Téléchargé {{ $post->nbDownload }} fois et aimer {{ $post->nbLike }} fois</p></h6>
            </div>
